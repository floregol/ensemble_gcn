...
def get_trained_gcn(seed,
    ...
    # Some preprocessing
    features_sparse = preprocess_features(features)
    ...
    # Create model
    model = model_func(placeholders, input_dim=input_dim, ensemble=ensemble, theta=theta, Gamma=Gamma, logging=True)
    ...
    for epoch in range(FLAGS.epochs):
        ...
        # Training step
        outs = sess.run([model.opt_op, model.loss, model.accuracy, model.softmax_output], feed_dict=feed_dict)
